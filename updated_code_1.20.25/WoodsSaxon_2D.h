...
public:
        ...
        double bins, double tx_min, double tx_max, double ty_min, double ty_max): Vo(Vo_init), R(R_init), a(a_init)
    {
        ...
        transform_TF2 = new TF2("Fourier-Bessel Transformation: G(x,y) -> |F(t_{x},t_{y})|^{2}", [this, x_min, x_max, y_min, y_max] (double *var, double *par)
        {
            double rr_min = 0., rr_max = 30;
            double tx = var[0], ty = var[1];
            TF1 transform_integral("trans_integral", F2_integrand_dr, rr_min, rr_max, 2);
        ...
        transform_hist = new TH2D("hankelTransformWS", "Transform Woods-Saxon ",bins ,tx_min, tx_max, bins, ty_min, ty_max);
    ...
    {
        double rr_min = 0., rr_max = 30;
        TF1 *f = new TF1("f", F2_integrand_dr, rr_min, rr_max, 2);  
