...
public:
        ...
        double bins, double t_min, double t_max): Vo(Vo_init), R(R_init), a(a_init)
    {
        ...
        // Initialize TF1
        WS1 = new TF1("", calc_WoodsSaxon1D, r_min, r_max, 3);
        WS1->SetParameters(Vo, R, a);

        // Initialize TH1D
        WS1_hist = new TH1D("", "Woods-Saxon", bins, r_min, r_max);
        WS1_hist->Sumw2();
        ...
        transform_TF1 = new TF1("", [this , rr_min, rr_max] (double *var, double *par)
        {
            double t = var[0];
            Double_t params[] = {t};
            TF1 transform_integral("", F_integrand_dr, rr_min, rr_max, 1);
            transform_integral.SetParameters(params);
        ...
        transform_hist = new TH1D("", "Transform Woods-Saxon", bins, t_min, t_max);
    ...
    {
        double rr_min = 0., rr_max = 100;
        TF1 *f = new TF1("", F_integrand_dr, rr_min, rr_max, 1); 
        Double_t params[] = {t};
