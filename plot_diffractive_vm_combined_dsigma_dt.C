...
void plot_diffractive_vm_combined_dsigma_dt()
{
		
	TString filename = "/home/macink/miniconda3/envs/bnl_research/macros/eic/EICreconOutputReader/output/combined_histograms.root";
	...
	TH1D* h_t_REC_new_method = dynamic_cast<TH1D*>(file->Get("h_t_REC_new_method_combined"));
	...
	if(filename=="MCclusterEnergy")
	{
		...
		w7->AddEntry(h_t_REC_new_method, "Sartre "+vm_label+" RECO new method", "P");
	}
