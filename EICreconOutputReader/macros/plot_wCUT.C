...
void plot_wCUT(TString filename="./output/eicrecon-sartre_coherent_phi_output.root")
{	
	...
	TH1D* h_t_REC_wCUT = (TH1D*) file->Get("h_t_REC_wCUT");
	...
	if(filename=="MCclusterEnergy")
	{
		...
		w7->AddEntry(h_t_REC_wCUT, "Sartre "+vm_label+" RECO new method", "P");
	...
	w7->Draw("same");
	c1->Print("./figures/tests/wCUT.pdf");
}
