...
void plot_2d_combined_wRES_cut()
{	
	TString filename = "/home/macink/miniconda3/envs/bnl_research/macros/eic/EICreconOutputReader/output/combined_2dhistograms_wRES_cut.root";
	...
	//t distribution
	TH2D* h_t_REC_2d_wRES_cut = dynamic_cast<TH2D*>(file->Get("h_t_REC_2d_wRES_cut_combined"));
