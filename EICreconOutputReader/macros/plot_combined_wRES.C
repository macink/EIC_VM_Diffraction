...
void plot_combined_wRES()
{
	...
	TH1D* h_t_REC_wRES = dynamic_cast<TH1D*>(file->Get("h_t_REC_wRES_combined"));
	...
	if(filename=="MCclusterEnergy")
	{
		...
		w7->AddEntry(h_t_REC_wRES, "Sartre "+vm_label+" RECO new method", "P");
	}
	...
	w7->Draw("same");
	c1->Print("/home/macink/miniconda3/envs/bnl_research/macros/eic/EICreconOutputReader/figures/combined/combined_wRES.pdf");
}
